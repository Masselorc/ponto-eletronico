...
from app.models.relatorio_completo import RelatorioMensalCompleto # Importa novo modelo
...
def relatorio_mensal():
    ...
    try:
        ...
        # Preenche form com dados salvos, se existirem
...
# Rota para VISUALIZAR o Relatório Completo em HTML
    ...
    try:
        ...
        contexto_completo = {
            **dados_relatorio_base,
            ...
            'declaracao_marcada': relatorio_salvo.declaracao_marcada,
            'data_geracao': relatorio_salvo.updated_at.strftime('%d/%m/%Y %H:%M:%S'), # Usa data da última atualização
            # Passa mes_atual e ano_atual para o template poder gerar o link de voltar corretamente
            'mes_atual': mes,
            'ano_atual': ano
        }
