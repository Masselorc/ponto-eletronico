...
import calendar # Necessário para ensure_column_exists
            ...
            with db.engine.connect() as connection:
                ...
                if column_name not in columns:
                    ...
                    try:
                        ...
                        # Para SQLite, commit pode não ser necessário para ALTER, mas vamos tentar com commit na conexão
                        if hasattr(connection, 'commit'): # Verifica se o objeto connection tem o método commit
                            connection.commit()
